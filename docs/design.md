...
- `src/green_taxi_tip_flow.py` owns orchestration, branching, and MLflow run boundaries.
- `src/green_taxi_tip_pipeline.py` owns data loading, validation, feature engineering, model construction, evaluation, decision logging, and registry operations.
